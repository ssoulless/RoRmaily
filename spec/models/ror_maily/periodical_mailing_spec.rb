...
describe RoRmaily::PeriodicalMailing do
  before(:each) do
    ...
    expect(@mailing).to be_kind_of(RoRmaily::PeriodicalMailing)
  ...
  describe "Subscribing" do
    ...
    it "should create schedule" do
      expect(RoRmaily::Log.scheduled.for_mailing(@mailing).count).to eq(1)
    end
  end
  ...
  describe "Periodical Delivery" do
    ...
    it "should deliver mailings after period" do
      ...
      expect(RoRmaily::Log.processed.count).to eq(0)
  ...
  describe "Without subscription" do
    ...
    it "should not deliver" do
      expect(RoRmaily::Subscription.count).to eq(0)
    ...
    it "should deliver with subscription override" do
      ...
      expect(RoRmaily::Log.scheduled.count).to eq(1)
