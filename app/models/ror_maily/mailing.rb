module RoRmaily
  class Mailing < Dispatch
    ...
    def deliver schedule
      ...
      RoRmaily.logger.log_processing(self, schedule.entity, prefix: "Error", level: :error) 
    ...
    def deliver_with_mailer schedule
      ...
      unless processable?(entity)
        ...
        RoRmaily.logger.log_processing(self, entity, prefix: "Not processable. Delaying schedule by one day", level: :debug) 
